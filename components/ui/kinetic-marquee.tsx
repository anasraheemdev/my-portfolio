...
export const KineticMarquee = memo(function KineticMarquee({
  text = "MUHAMMAD ANAS RAHEEM — AI & FULL-STACK — ISLAMABAD — ",
  className,
  baseVelocity = 0.5,
  skewFactor = 0.5,
}: KineticMarqueeProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        // Skew on a very wide row inflates the axis-aligned bounding box vertically;
        // overflow-y must stay visible or letters get clipped top/bottom.
        "w-full overflow-x-hidden overflow-y-visible py-4 md:py-6 pointer-events-none select-none",
        className
      )}
    >
      <div
      ...
      >
        <span
          className="font-harmond text-[8vw] md:text-[6vw] lg:text-[5vw] font-bold tracking-tight text-transparent uppercase leading-[1.15] inline-block py-1"
          style={{
